        ...
        <Card className="w-full max-w-md border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-indigo-500/10">
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <Input
                    ...
                    className="h-11 bg-slate-50/50 dark:bg-slate-950/50 border-slate-200 dark:border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/10 focus:outline-none focus:outline-none transition-all duration-200"
                />
                {errors.email && (
