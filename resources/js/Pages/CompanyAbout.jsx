    ...
    <AppLayout>
      <div className="font-['Poppins'] bg-slate-50 dark:bg-[#020617] min-h-screen py-12 transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Main Profile Card */}
          <div className="bg-[#F2EBE6] dark:bg-slate-900 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800 p-6 sm:p-10 relative overflow-hidden">
              ...
              <div className="flex-1 text-center md:text-left space-y-4">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4">
                  <a
                    ...
                    className="px-8 py-2 rounded-xl text-sm font-bold bg-[#F8721B] dark:bg-indigo-600 text-white dark:hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-500/20 active:scale-95"
                  >
                    Visit Website
                  </a>
                </div>
