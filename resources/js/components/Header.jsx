...
export default function Header({ auth }) {
    ...
    return (
        ...
        //                     <Link
        //                         href="/dashboard"
        //                         className="px-5 py-2 rounded-2xl text-sm font-bold transition-all active:scale-95 shadow-sm bg-white text-[#F8721B] border border-[#F8721B] hover:bg-[#F8721B] hover:text-white transition-all active:scale-95"
        //                     >
        //                         Dashboard
        //                     </Link>
        //                 ) : (
        ...
        //                     className="flex justify-center w-full py-2 rounded-2xl bg-[#F8721B] text-white font-black shadow-lg shadow-orange-500/30"
        //                 >
            ...
            >
                <div className="flex flex-col space-y-3 px-4">
                    <a
                        ...
                        className="px-4 py-3 rounded-xl font-bold text-slate-600 hover:bg-[#FB721B] hover:text-white"
                    >
                        Browse Jobs
                    </a>
