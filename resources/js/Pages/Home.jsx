        ...
        <section className="relative pt-16 pb-12 sm:pt-24 sm:pb-20 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
                    Your Future in <br />
                    <span className="text-transparent bg-clip-text bg-[#F8721B] dark:from-blue-400 dark:to-indigo-300">
                    Remote Nursing
                    </span>
                </h1>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    <a href="#job-listings" className="px-8 py-4 bg-[#F8721B] dark:bg-blue-600 text-white font-bold rounded-2xl shadow-xl shadow-blue-500/20 hover:scale-105 transition-transform active:scale-95">
                    Browse Jobs
                    </a>
                </div>
                </div>
