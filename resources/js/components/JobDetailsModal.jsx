...
>
  <div
    className="relative bg-slate-50 w-full max-w-5xl rounded-[1rem] shadow-2xl max-h-[90vh] overflow-hidden border border-slate-200 flex flex-col animate-in zoom-in-95 duration-200"
  ...
  >
    ...
    <div className="overflow-y-auto p-6 sm:p-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12">
        ...
        {/* LEFT COLUMN: Job Details (Order 1 on Mobile) */}
        <div className="lg:col-span-8 space-y-10 order-1 bg-white p-5 sm:p-6 rounded-[2rem] shadow-sm">
          {/* Badges */}
        ...
        {/* RIGHT COLUMN: Summary (Order 2 on Mobile) */}
        <div className="lg:col-span-4 space-y-6 order-2 lg:order-none">
          <div className="p-6 bg-white rounded-[2rem] border border-slate-200/50 shadow-xl shadow-slate-200/30 space-y-6">
        ...
        {/* BOTTOM SECTION: Company Info (Order 3 on Mobile, Left Column on Desktop) */}
        <div className="lg:col-span-12 order-3 lg:mt-[-2rem] w-full">
          <section className="p-6 bg-white rounded-3xl border border-slate-200/50">
