...
export default function Register() {
  ...
  return (
    ...
    <AppLayout>
  <Head title="Create an account" />
  {/* Unified wrapper: Exactly the same classes as Login for identical spacing */}
    ...
    <div className="relative z-10 w-full max-w-md bg-white rounded-2xl border border-slate-200 p-8 transition-all">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-1">
          ...
          <input type="text" className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 outline-none focus:ring-2 focus:ring-[#F8721B]" placeholder="John Doe" />
        </div>

        <div className="space-y-1">
          <label className="text-sm font-semibold text-slate-700">Email Address</label>
          <input type="email" className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 outline-none focus:ring-2 focus:ring-[#F8721B]" placeholder="you@example.com" />
        </div>

        <div className="space-y-1">
          <label className="text-sm font-semibold text-slate-700">Password</label>
          <input type="password" className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 outline-none focus:ring-2 focus:ring-[#F8721B]" placeholder="••••••••" />
        </div>
        ...
        <button type="submit" className="w-full py-2.5 px-4 mt-2 rounded-xl font-bold text-white bg-[#F8721B] hover:bg-[#e06317] transition-all active:scale-[0.98] shadow-lg shadow-slate-200">
          Create Account
        </button>
      </form>
      ...
      <div className="mt-8 pt-6 border-t border-slate-100 text-center">
        <p className="text-slate-600 text-sm">
          Already have an account? <a href="/login" className="font-bold text-[#F8721B] hover:underline">Sign in</a>
        </p>
      </div>
    </div>
  </div>
